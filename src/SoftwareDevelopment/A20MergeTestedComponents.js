...
class A20MergeTestedComponents extends Component {
    render(){
        return (
            <div>
                <NavigationBar />
                        ...
                        <Row>
                            <Col md lg="8">
                                <Table>
                                    <thead>
                                        <th>Activity</th>
                                        <th>A5.2 Merge all the tested components to the main dev branch and upload the task manager</th>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td><b>Roles</b></td>
...
export default A20MergeTestedComponents