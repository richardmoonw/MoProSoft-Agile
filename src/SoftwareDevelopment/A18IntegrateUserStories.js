...
class A18IntegrateUserStories extends Component {
    render(){
        return (
            <div>
                <NavigationBar />
                        ...
                        <Row>
                            <Col md lg="8">
                                <Table>
                                    <thead>
                                        <th>Activity</th>
                                        <th>A4.3 Integrate the user stories' software to whole project in the configuration management system</th>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <td><b>Roles</b></td>
...
export default A18IntegrateUserStories